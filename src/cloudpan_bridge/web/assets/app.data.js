window.CloudPanBridgeData = (() => {
    const I18N = {
      zh: {
        ...
        "btn.target_guidance_open_mounts": "去连接页检查 OpenList",
        "btn.target_guidance_expand": "展开连接详情",
        "btn.target_guidance_capture": "去登录抓取光鸭",
        "btn.target_guidance_open_task": "去任务页确认目标目录",
        "btn.source_guidance_open_mounts": "去连接页挂载源网盘",
        "btn.source_guidance_browse_mounted": "从已挂载源开始浏览",
        "btn.source_guidance_use_current": "把当前目录设为源目录",
        "btn.source_guidance_open_task": "去任务页确认目标目录",
        "btn.task_guidance_open_source": "去源端选择目录",
        "btn.task_guidance_open_target": "去目标端补配置",
        "btn.task_guidance_open_target_details": "展开目标端连接详情",
        "btn.task_guidance_open_execute": "去执行页开始同步",
        "btn.execute_guidance_open_source": "先去选源目录",
        "btn.execute_guidance_open_target": "先去配目标端",
        "btn.execute_guidance_open_task": "先去确认任务配置",
        "btn.mounts_guidance_install_runtime": "先拉取本机运行时",
        "btn.mounts_guidance_login_openlist": "登录 OpenList 并写回 Token",
        "btn.mounts_guidance_refresh_storages": "刷新挂载列表",
        "btn.mounts_guidance_open_source": "去源端选择目录",
        "btn.mounts_guidance_open_capture": "去抓取源网盘登录态",
      ...
      en: {
        ...
        "btn.target_guidance_open_mounts": "Check OpenList Connection",
        "btn.target_guidance_expand": "Open Connection Details",
        "btn.target_guidance_capture": "Capture Guangya Login",
        "btn.target_guidance_open_task": "Confirm Target Directory",
        "btn.source_guidance_open_mounts": "Create Source Mount",
        "btn.source_guidance_browse_mounted": "Browse Mounted Source",
        "btn.source_guidance_use_current": "Use Current Directory",
        "btn.source_guidance_open_task": "Confirm Target Directory",
        "btn.task_guidance_open_source": "Choose Source Directory",
        "btn.task_guidance_open_target": "Complete Target Setup",
        "btn.task_guidance_open_target_details": "Open Target Details",
        "btn.task_guidance_open_execute": "Go to Execute",
        "btn.execute_guidance_open_source": "Choose Source First",
        "btn.execute_guidance_open_target": "Configure Target First",
        "btn.execute_guidance_open_task": "Review Task Settings",
        "btn.mounts_guidance_install_runtime": "Install Local Runtime",
        "btn.mounts_guidance_login_openlist": "Login and Save Token",
        "btn.mounts_guidance_refresh_storages": "Refresh Mount List",
        "btn.mounts_guidance_open_source": "Go to Source",
        "btn.mounts_guidance_open_capture": "Capture Provider Login",
